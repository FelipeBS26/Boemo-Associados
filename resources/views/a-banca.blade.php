...
@section('content')
    <section class="relative pt-40 pb-32 border-b border-champagne/20 overflow-hidden">
        ...
        <div class="absolute inset-0 w-full h-full bg-fixed bg-center bg-cover" style="background-image: url('https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=1920&q=80');"></div>
        ...
        <div class="max-w-6xl mx-auto px-6 space-y-32">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center group">
                <div class="lg:col-span-5 relative">
                    ...
                    <div class="h-[500px] bg-black/10 rounded-2xl relative z-10 flex items-center justify-center shadow-lg overflow-hidden">
                         <span class="text-midnight/40 text-base font-body">[ Imagem: Harvey Specter Vertical ]</span>
                    </div>
                </div>
                <div class="lg:col-span-7 lg:pl-10">
                    ...
                    <p class="text-midnight/85 leading-relaxed font-normal mb-6 text-lg">
                    ...
                    <p class="text-midnight/85 leading-relaxed font-normal mb-8 text-base">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center group">
                ...
                <div class="lg:col-span-5 relative order-1 lg:order-2">
                    <div class="absolute -inset-2 border border-champagne rounded-3xl opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 z-0"></div>
                    <div class="h-[500px] bg-black/10 rounded-2xl relative z-10 flex items-center justify-center shadow-lg overflow-hidden">
                         <span class="text-midnight/40 text-base font-body">[ Imagem: Jessica Pearson Vertical ]</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center group">
                <div class="lg:col-span-5 relative">
                    <div class="absolute -inset-2 border border-champagne rounded-3xl opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 z-0"></div>
                    <div class="h-[500px] bg-black/10 rounded-2xl relative z-10 flex items-center justify-center shadow-lg overflow-hidden">
                         <span class="text-midnight/40 text-base font-body">[ Imagem: Louis Litt Vertical ]</span>
                    </div>
                </div>
                <div class="lg:col-span-7 lg:pl-10">
    ...
    <section class="py-24 bg-white border-t border-champagne/10 text-center">
        <div class="max-w-3xl mx-auto px-6">
            ...
            <p class="text-midnight/60 font-normal mb-10 leading-relaxed">
            ...
            <a href="/contato" class="inline-flex items-center justify-center bg-midnight text-white px-10 py-4 text-base font-bold uppercase tracking-widest rounded-full hover:bg-champagne transition-all duration-300 shadow-lg">
